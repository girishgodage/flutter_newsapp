...
<table style="border:1px solid;">
  ...
  <tr >
    <td style="text-align: center; border:1px solid;padding:1em;">
        <img width="60%" src="https://github.com/girishgodage/flutter_newsapp/blob/main/Assets/newsapp_main.png">
    </td>
    <td style="text-align: center; border:1px solid;padding:1em;">
         <img width="60%" src="https://github.com/girishgodage/flutter_newsapp/blob/main/Assets/newsapp_details.png">
    </td>
  </tr>
